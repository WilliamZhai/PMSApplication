...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("PMSApplication API Documentation")
                .contact(new Contact("William", "https://www.williamzhai.com/","zhaiwilliam@gmail.com"))
                .version("1.0")
                .build();
    }

    // workaround for issue relating to springfox and actuator path match strategy
